...
r_text[1] = "Professorne tholpikkaan ningalkavilla. Jeevitathil Pickachune tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
r_text[2] = "Professor says i love you 😘";
r_text[3] = "Professorinte yudhangal Company Kanan Povunnatheyuloo";
r_text[4] = "hi, how are you";
r_text[5] = "ennikk korch rest theroo...🥵🥵";
r_text[6] = "Professor - eva - simsim \ningane ethra ethra paerugal aan alle enikk..😂🤣";
...
r_text[8] = "\n enne vilicho...?🧐 \n";
r_text[9] = "ente per Professor,ninte per donkey, backi ellarum monkey😼😼";
r_text[10] = "nee vilicha enikk villi kelkathe irrikkaan pattuo";
r_text[11] = "do you know who is my creator..? its none other than ansanshif";
...
r_text[21] = "Kochi pazhaya kochiyellennariyam… pakshe Professor pazhaya Professor thanneya...😎\n\n";
r_text[22] = "Kaanaan oru look illanney ullu… bhayankara budhiya\n\n ninnak allatto enik Professor";
r_text[23] = "Ithalla ithinapparam chaadi kadannavananee K.K. Professor";
